...
int main()
{
    ...
    if (dP1 == dP2) PuntoMasCercano = "P1, P2. ";
    else PuntoMasCercano = (dMin == dP1) ? "P1. " : "P2. ";
    cout << endl << "Punto(s) mas cercano(s) al origen: " << PuntoMasCercano << endl;
    cout.precision(2);
    cout << fixed;
